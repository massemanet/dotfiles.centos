...
(eval-and-compile
  (defvar erlang-operators-symbol-regexp
    (regexp-opt '("+" "-" "*" "/" ">" ">=" "<" "=<" "=:=" "==" "=/=" "/=") t)
    "Erlang operators (symbols)"))

(eval-and-compile
  (defvar erlang-list-operators-regexp
    (regexp-opt '("++" "--") t)
    "Erlang list operators"))

(eval-and-compile
  (defvar erlang-match-operator-regexp
    (regexp-opt '("=") t)
    "Erlang match operator"))
...
(defvar erl-list-operators-face     nil)
(defvar erl-match-operator-face     nil)
...
(defvar erlang-font-lock-keywords-operators-symbol
  (list
   (list erlang-operators-symbol-regexp
         1 'erl-operator-face))
  "Font lock keyword highlighting Erlang operators (symbols).")

(defvar erlang-font-lock-keywords-list-operators
  (list
   (list erlang-list-operators-regexp
         1 'erl-list-operator-face))
  "Font lock keyword highlighting Erlang list operators.")

(defvar erlang-font-lock-keywords-match-operator
  (list
   (list erlang-match-operator-regexp
         1 'erl-match-operator-face))
  "Font lock keyword highlighting Erlang match operator `='.")
...
(defvar erlang-font-lock-kwords
  '((1 . erlang-font-lock-keywords-function-header)
    ...
    (3 . erlang-font-lock-keywords-operators-symbol)
    (3 . erlang-font-lock-keywords-list-operators)
    (3 . erlang-font-lock-keywords-match-operator)
